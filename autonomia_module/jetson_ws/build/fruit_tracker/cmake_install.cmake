# Install script for directory: /home/nvidia/jetson_ws/src/fruit_tracker
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/pkgconfig" TYPE FILE FILES "/home/nvidia/jetson_ws/build/fruit_tracker/catkin_generated/installspace/fruit_tracker.pc")
endif()

if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/fruit_tracker/cmake" TYPE FILE FILES
    "/home/nvidia/jetson_ws/build/fruit_tracker/catkin_generated/installspace/fruit_trackerConfig.cmake"
    "/home/nvidia/jetson_ws/build/fruit_tracker/catkin_generated/installspace/fruit_trackerConfig-version.cmake"
    )
endif()

if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/share/fruit_tracker" TYPE FILE FILES "/home/nvidia/jetson_ws/src/fruit_tracker/package.xml")
endif()
